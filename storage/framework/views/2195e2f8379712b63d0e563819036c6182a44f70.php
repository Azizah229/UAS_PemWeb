        ...
        <div class="col-sm-6">
          ...
          <div class="d-grid gap-2 col-12 mx-auto">
            <button class="btn btn-dark" type="button" style="font-family: 'Britannic'; font-size: 30px;">
              <a class="nav-link <?php echo e(($nama === "Resep") ? 'active' : ''); ?>" href="/resep">More Recipes?
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sicory2\resources\views/home.blade.php ENDPATH**/ ?>